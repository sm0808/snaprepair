...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modal_final_fare__ = __webpack_require__(907);
...
var ModalFinalFarePageModule = (function () {
    ...
    ModalFinalFarePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__modal_final_fare__["a" /* ModalFinalFarePage */]),
            ],
        })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_user_user__ = __webpack_require__(36);
...
var ModalFinalFarePage = (function () {
    ...
    ModalFinalFarePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-modal-final-fare',template:/*ion-inline-start:"/Users/mac/Desktop/Twubs App/snapServer/snaprepair/src/pages/modal-final-fare/modal-final-fare.html"*/'<!--\n  Generated template for the ModalPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar color=app>\n\n\n    <ion-title>\n      Invoice\n    </ion-title>\n\n  </ion-navbar>\n\n\n</ion-header>\n\n\n<ion-content style="color:black">\n\n\n  <ion-grid>\n\n    <ion-row>\n      <ion-col col-6 text-left class="type">\n        Total Mileage\n      </ion-col>\n\n      <ion-col col-6 text-left class="price">\n\n        {{data[\'distance\']}}\n      </ion-col>\n    </ion-row>\n    <ion-row *ngIf="data[\'isBaseFare\'] == true">\n      <ion-col col-6 text-left class="type">\n        Basic Price\n      </ion-col>\n\n      <ion-col col-6 text-left class="price">\n\n         {{data[\'distanceCost\']}}\n      </ion-col>\n    </ion-row>\n  <ion-row *ngIf="data[\'isBaseFare\'] == false">\n      <ion-col col-6 text-left class="type">\n        Distance Cost\n        <br>\n        <small>1.30 $ Per Mile</small>\n      </ion-col>\n\n      <ion-col col-6 text-left class="price">\n\n         {{data[\'distanceCost\']}}\n      </ion-col>\n    </ion-row>\n\n    <ion-row>\n      <ion-col col-6 text-left class="type">\n        Time Cost\n        <br>\n        <small>20.00 Cents Per Min </small>\n      </ion-col>\n\n      <ion-col col-6 text-left class="price">\n\n        {{data[\'timeCost\']}}\n      </ion-col>\n    </ion-row>\n    <hr>\n    <ion-row>\n      <ion-col col-6 text-left class="type">\n        Fare\n      </ion-col>\n\n      <ion-col col-6 text-left class="price">\n\n        {{data[\'fare\']}}\n      </ion-col>\n    </ion-row>\n    <ion-row>\n      <ion-col col-6 text-left class="type">\n        Discount\n      </ion-col>\n\n      <ion-col col-6 text-left class="price">\n\n        {{data[\'discount\']}}\n      </ion-col>\n    </ion-row>\n    <ion-row>\n      <ion-col col-6 text-left class="type">\n        GST(7.25%)\n      </ion-col>\n    \n      <ion-col col-6 text-left class="price">\n    \n        {{data[\'gst\']}}\n      </ion-col>\n    </ion-row>\n\n    <hr>\n<ion-row>\n  <ion-col col-6 text-left class="type">\n    Tolls\n  </ion-col>\n\n  <ion-col col-6 text-left class="price">\n\n    {{data[\'tolls\']}}\n  </ion-col>\n</ion-row>\n<ion-row *ngIf="data[\'tip\'] >0">\n  <ion-col col-6 text-left class="type">\n    Tip\n  </ion-col>\n\n  <ion-col col-6 text-left class="price">\n\n    {{data[\'tip\']}}\n  </ion-col>\n</ion-row>\n    <hr>\n    <ion-row>\n      <ion-col col-6 text-left>\n        <h1 style="margin-top: 0px;">Total Fare</h1>\n      </ion-col>\n\n      <ion-col col-6 text-left class="price" >\n        <h1 style="margin-top: 0px;">{{data[\'total\']}}</h1>\n        \n      </ion-col>\n    </ion-row>\n  </ion-grid>\n\n</ion-content>\n\n\n<ion-footer transparent>\n  <ion-toolbar transparent>\n    <button ion-button full color=app (click)="dismiss()">Confirm</button>\n  </ion-toolbar>\n</ion-footer>'/*ion-inline-end:"/Users/mac/Desktop/Twubs App/snapServer/snaprepair/src/pages/modal-final-fare/modal-final-fare.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4__services_trip_service__["a" /* TripService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_3__providers_user_user__["a" /* UserProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* NavParams */],
            ...
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["w" /* ViewController */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_local_notifications__["a" /* LocalNotifications */]])
    ], ModalFinalFarePage);
